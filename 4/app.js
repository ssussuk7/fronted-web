...
var start_num = 1;
var listnumber = 5;
var end_num = Math.ceil(todayPhoto.length / listnumber );

var listnum_show = document.getElementById('listnum')

function listnum(firstnum, endnum)
{
  listnum_show.innerHTML = firstnum +" / "+ endnum;
}

var wrap = document.querySelector('.wrap');

function show_image(start)
{
  var str = '';
  for(i = start; i < start + listnumber; i++)
  {
...
next.addEventListener('click',function(){
  start_num++;
  start = (start_num * listnumber) - listnumber;
